...
export function FillInPage() {
  const { question, next, answer, finished, index, total, results } = useQuiz("fillin");
  const questionNumber = index + 1;

  if (finished) {
    return (
      <div data-component="FillInPage" className="max-w-lg mx-auto py-8 px-4 flex flex-col gap-6">
        ...
        <ReviewSection results={results} mode="fillin" />
      </div>
    );
  }
